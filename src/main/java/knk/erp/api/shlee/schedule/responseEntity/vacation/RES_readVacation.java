...
import knk.erp.api.shlee.schedule.dto.Vacation.VacationDetailData;
...
public class RES_readVacation {
    ...
    private VacationDetailData data;
    ...
    //ok
    public RES_readVacation(String code, VacationDetailData data) {
        createCodeList();
        this.code = code;
        this.data = data;
    }
